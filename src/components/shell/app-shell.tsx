    ...
    <div className="min-h-[100dvh]">
      ...
      >
        ...
        <div className="px-4 pb-5 pt-1">
          <Link
            href="/record"
            className="flex h-11 items-center justify-center gap-2 rounded-btn bg-ink text-[13.5px] font-semibold text-bg transition-[transform,background-color] duration-150 [transition-timing-function:var(--ease-out)] hover:bg-ink-soft active:scale-[0.98] cursor-pointer"
          >
      ...
      >
        <Link href="/" className="inline-flex items-center gap-2 cursor-pointer">
          <SignalMark size={18} />
          <span className="font-display text-[18px] leading-none text-ink">Glacianav</span>
        </Link>
