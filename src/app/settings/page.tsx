    ...
    <AppShell user={session.user}>
      <main className="mx-auto max-w-2xl px-4 pb-28 pt-5 sm:px-6 md:px-8 md:pb-12 md:pt-7">
        <div className="mb-5 border-b border-hairline px-1 pb-5">
          <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-faint">Control panel</p>
          <h1 className="mt-1.5 font-display text-[30px] font-normal leading-none tracking-[-0.01em] text-ink">Account</h1>
